...
switch(_shop) do
{
	case "cop_basic":
	{
		switch(true) do
		{
	        ...
	        case (__GETC__(life_donator) == 2):
				{
				["Donator Tier 2", //Donator Tier 2 cop shop
					[
						["arifle_sdar_F","Taser Rifle",20000],
						["20Rnd_556x45_UW_mag","Taser Rifle Magazine",125],
						["arifle_MX_F",nil,35000],
	...
	case "genericadmin_gun":
	{
		["genericadmin's Weapon Shop",
			[
				["Binocular",nil,150]
			]
		];
	...
	case "pmc_gun":
	{
		...
		{
			case (playerSide != civilian): {"You are not a civilian!"};
			case (!license_pmc): {"You do not have PMC license!"};
			default
			{
				["PMC Weapon Shop",
					[
						...
						["SMG_01_F",nil,25000],
						["30Rnd_45ACP_Mag_SMG_01_tracer_green",nil,75],
						["SMG_02_F",nil,20000],
						["30Rnd_9x21_Mag",nil,50],
						["hgun_Rook40_F",nil,2500],
						["16Rnd_9x21_Mag",nil,25],
						["launch_NLAW_F",nil,150000],
						["NLAW_F",nil,5000],
