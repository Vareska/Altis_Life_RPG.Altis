...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_C_Poor_1","Poor Boy",250],
		["U_C_Poor_2","Another Poor Boy",250],
		["U_C_Poor_shorts_1","Worn Shorts",2150],
		["U_C_HunterBody_grn","The Green Hunter",1500]
		];
	};
	...
	case 1:
	{
		[
			...
			["H_Cap_red",nil,150],
			["H_Cap_tan",nil,150],
			["H_HelmetB","The Hardhat",300],
			["H_HelmetB_camo","The Camo Hardhat",300]
		];
	};
	...
	case 2:
	{
		[
			...
			["G_Lowprofile",nil,30],
			["G_Combat",nil,55],
			["G_Lady_Mirror",nil,40],
			["G_Aviator","Ray Ban",100]
		];
	};
