...
if(_veh == "I_Plane_Fighter_03_AA_F") then 
{
	...
	_vehicle addAction["<t color='#FF0000'>Smoke</t>","scripts\jetsmoke\red.sqf"];   
	_vehicle addAction["Smoke","scripts\jetsmoke\white.sqf"];   
	_vehicle addAction["<t color='#0000FF'>Smoke</t>","scripts\jetsmoke\blue.sqf"];
};
