...
switch(life_veh_shop) do
{
	...
	case "pmc_car":
	{
		_sp = getMarkerPos "pmc_car";
		_dir = markerDir "pmc_car";
	};
	
	
	case "genericadmin_car":
	{
		_sp = getMarkerPos "genericadmin_car";
		_dir = markerDir "genericadmin_car";
	};
	
	case "donator_heli_kavala":
	{
		_sp = getMarkerPos "donator_heli_kavala";
		_dir = markerDir "donator_heli_kavala";
	};
};
