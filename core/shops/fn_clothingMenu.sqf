...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","pmc"] && playerSide == west) exitWith {hint "You need to be a civilian to use this store!"; closeDialog 0;};
if((_this select 3) == "reb" && !license_civ_rebel) exitWith {hint "You don't have rebel training yet!"; closeDialog 0;};
if((_this select 3) == "pmc" && !license_pmc) exitWith {hint "You need PMC Training to buy this clothing!"; closeDialog 0;};
