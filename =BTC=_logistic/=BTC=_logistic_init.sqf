...
if (BTC_active_lift == 1) then
{
	...
	BTC_def_hud       = 0;
	BTC_def_pip       = 0;
	BTC_l_def_veh_pip = ["O_Heli_Light_02_unarmed_F","B_Heli_Light_01_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F","B_Heli_Light_01_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","I_Heli_Transport_02_F"];
	...
	BTC_get_liftable_array =
	{
		...
		{
			//MH9
			case "B_Heli_Transport_01_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
			//PO-30
			case "O_Heli_Light_02_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
			//UH80
			case "B_Heli_Light_01_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
			//CH49
			case "I_Heli_Transport_02_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};
			//WY-55 Hellcat unarmed green
			case "I_Heli_light_03_unarmed_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};			
			//WY-55 Hellcat
			case "O_Heli_Light_02_unarmed_F" : {_array = ["Motorcycle","Car","Truck","Wheeled_APC"];};		
	};
		_array
	};
};
if (BTC_active_fast_rope == 1) then
{
	...
	BTC_roping_chopper = ["O_Heli_Light_02_unarmed_F","I_Heli_light_03_F","I_Heli_light_03_unarmed_F","B_Heli_Light_01_F","O_Heli_Light_02_F","B_Heli_Transport_01_F","I_Heli_Transport_02_F"];
